                    ...
                    var _loop2 = function _loop2() {
                      ...
                      pagePool.queue(function () {
                        var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(page) {
                          var symbolByViewport, viewportKey, symbol;
                              ...
                              switch (_context3.prev = _context3.next) {
                                ...
                                case 2:
                                  ...
                                  for (viewportKey in symbolByViewport) {
                                    ...
                                    _this.tallestByViewport[viewportKey] = Math.max(_this.tallestByViewport[viewportKey] || 0, symbol.frame.height);
    ...
    value: function positionSymbols() {
      ...
      try {
        for (var _iterator5 = (0, _getIterator3.default)(this.sortedViewports), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          var symbols = this.symbolsByViewport[id].filter(function (x) {
            return x;
          });
          ...
          try {
            for (var _iterator6 = (0, _getIterator3.default)(symbols), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
