  ...
  (0, _createClass3.default)(Story2sketch, [{
    ...
    value: function () {
      var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6() {
        ...
        var xOffset, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _ref15, id, symbols, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, symbol;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 9:
                ...
                _ref15 = _step5.value;
                id = _ref15.id;
                symbols = this.symbolsByViewport[id].filter(function (x) {
                  return x;
                });
                ...
                for (_iterator6 = (0, _getIterator3.default)(symbols); !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                  symbol = _step6.value;
